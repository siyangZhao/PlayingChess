	...
	public int action(Game G){
		...
		switch(actionid){
			case 1:
				...
				break;
			case 2:
				System.out.println("请输入移动棋子的源和目标的位置x1, y1和x2, y2(用空格间隔):");
				x1 = sc.nextInt();
				y1 = sc.nextInt();
				x2 = sc.nextInt();
				y2 = sc.nextInt();
				...
				break;
			case 3:
				System.out.println("请输入提子位置x,y(用空格间隔):");
				x = sc.nextInt();
				y = sc.nextInt();
				...
				break;
			case 4:
				System.out.println("请输入吃子的源和目标的位置x1, y1和x2, y2(用空格间隔):");
				x1 = sc.nextInt();
				y1 = sc.nextInt();
				x2 = sc.nextInt();
				y2 = sc.nextInt();
				...
				break;
			case 5:
				System.out.println("请输入查找的位置x,y(用空格间隔):");
				x = sc.nextInt();
				y = sc.nextInt();
				destp = G.board.game_board[x][y];
